...
$search_pattern = isset($_GET['search']) ? trim($_GET['search']) : '';
...
try {
    $count_stmt = $pdo -> prepare("SELECT COUNT(*) FROM listings");
    $count_stmt -> execute();
    ...
    $stmt = $pdo -> prepare("
        ...
        LIMIT ? OFFSET ?
    ");
    $stmt -> bindValue(1, $listings_per_page, PDO::PARAM_INT);
...
if ($search_pattern !== '') {
    $filtered_listings = filter_listings($listings, $search_pattern); 
...
<body>
    <div class="listings-container">
        ...
        <div class="listings-header">        
            ...
            <a href="../index.php?page=create_listing" id="redirect-create-listing">Create your own listing!</a>

            <form method="get" action="">
                <input type="text" name="search" id="search" placeholder="Search listings..." value="<?php echo htmlspecialchars($search_pattern); ?>">
        ...
        <?php if (empty($listings)): ?>
            <div class="no-listings">
                ...
                <p>Be the first to create a listing, <a href="../index.php?page=create_listing">Here!</a></p>
            </div>
        <?php else: ?>
